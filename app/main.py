...
from app.api.routes import data, health, ohlc, scanner, scanner_run, signals, status, symbols
from app.core.config import get_settings

settings = get_settings()
app = FastAPI(title=settings.app_name, version=settings.app_version,
              description="Local-only API foundation for the DSE Pulse frontend.")
